    ...
    const getRandomColor = () => {
      ...
      return (
        <div style={{ backgroundColor, padding: '20px', borderRadius: '10px' }}>
          ...
          <p style={{ color: quoteColor, fontStyle: 'italic', marginBottom: '10px' }}>{currentQuote.author}</p>
          <button
            onClick={generateRandomQuote}
            style={{ backgroundColor: buttonColor, color: '#fff', padding: '10px', borderRadius: '5px', cursor: 'pointer' }}
          >
            Generate New Quote
          </button>
        </div>
